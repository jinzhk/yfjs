...
define('echarts2/echarts', [
    ...
    'zrender2/tool/color',
    './component/timeline',
    'zrender2/shape/Image',
    'zrender2/loadingEffect/Bar',
    'zrender2/loadingEffect/Bubble',
    'zrender2/loadingEffect/DynamicLine',
    'zrender2/loadingEffect/Ring',
    'zrender2/loadingEffect/Spin',
    'zrender2/loadingEffect/Whirling',
    './theme/macarons',
    './theme/infographic'
], function (require) {
...
});define('zrender2/tool/env', [], function () {
    function detect(ua) {
        var os = this.os = {};
...
});define('zrender2', ['zrender2/zrender'], function (main) {return main;});
define('zrender2/zrender', [
    'require',
    './dep/excanvas',
    './tool/util',
    './tool/log',
    ...
    return zrender;
});define('zrender2/config', [], function () {
    var config = {
        EVENT: {
            RESIZE: 'resize',
            CLICK: 'click',
    ...
    return Island;
});define('echarts2/component/toolbox', [
    'require',
    './base',
    'zrender2/shape/Line',
    'zrender2/shape/Image',
    'zrender2/shape/Rectangle',
    '../util/shape/Icon',
    '../config',
    'zrender2/tool/util',
    'zrender2/config',
    ...
    return Toolbox;
});define('echarts2/component', [], function () {
    var self = {};
    ...
    return self;
});define('echarts2/component/title', [
    'require',
    './base',
    'zrender2/shape/Text',
    'zrender2/shape/Rectangle',
    ...
    return Title;
});define('echarts2/component/tooltip', [
    'require',
    './base',
    '../util/shape/Cross',
    'zrender2/shape/Line',
    ...
    return Tooltip;
});define('echarts2/component/legend', [
    'require',
    './base',
    'zrender2/shape/Text',
    'zrender2/shape/Rectangle',
    'zrender2/shape/Sector',
    '../util/shape/Icon',
    '../util/shape/Candle',
    '../config',
    'zrender2/tool/util',
...
});define('echarts2/chart', [], function () {
    var self = {};
    var _chartLibrary = {};
    self.define = function (name, clazz) {
...
});define('echarts2/component/timeline', [
    'require',
    './base',
    'zrender2/shape/Rectangle',
    '../util/shape/Icon',
    ...
    return ZImage;
});define('zrender2/loadingEffect/Bar', [
    'require',
    './Base',
    '../tool/util',
    '../tool/color',
    ...
    return Bar;
});define('zrender2/loadingEffect/Bubble', [
    'require',
    './Base',
    '../tool/util',
    '../tool/color',
    ...
    return Bubble;
});define('zrender2/loadingEffect/DynamicLine', [
    'require',
    './Base',
    '../tool/util',
    '../tool/color',
    ...
    return DynamicLine;
});define('zrender2/loadingEffect/Ring', [
    'require',
    './Base',
    '../tool/util',
    '../tool/color',
    ...
    return Ring;
});define('zrender2/loadingEffect/Spin', [
    'require',
    './Base',
    '../tool/util',
    '../tool/color',
    ...
    return Spin;
});define('zrender2/loadingEffect/Whirling', [
    'require',
    './Base',
    '../tool/util',
    '../tool/area',
    ...
    return theme;
});define('zrender2/dep/excanvas', ['require'], function (require) {
...
});define('zrender2/mixin/Eventful', ['require'], function (require) {
...
});define('zrender2/tool/guid', [], function () {
    var idStart = 2311;
    return function () {
        return 'zrender__' + idStart++;
    };
});define('zrender2/Handler', [
    'require',
    './config',
    './tool/env',
    './tool/event',
    ...
    return Storage;
});define('zrender2/animation/Animation', [
    'require',
    './Clip',
    '../tool/color',
    '../tool/util',
    ...
    return Animation;
});define('zrender2/tool/vector', [], function () {
    ...
    return vector;
});define('zrender2/tool/matrix', [], function () {
    var ArrayCtor = typeof Float32Array === 'undefined' ? Array : Float32Array;
    var matrix = {
        create: function () {
    ...
    return matrix;
});define('zrender2/loadingEffect/Base', [
    'require',
    '../tool/util',
    '../shape/Text',
    '../shape/Rectangle'
    ...
    return Text;
});define('zrender2/shape/Rectangle', [
    'require',
    './Base',
    '../tool/util'
], function (require) {
...
});define('zrender2/mixin/Transformable', [
    'require',
    '../tool/matrix',
    '../tool/vector'
], function (require) {
    ...
    return Group;
});define('zrender2/animation/Clip', [
    'require',
    './easing'
], function (require) {
    ...
    return Clip;
});define('zrender2/animation/easing', [], function () {
    var easing = {
        Linear: function (k) {
            return k;
        },
    ...
    return easing;
});define('echarts2/chart/base', [
    'require',
    'zrender2/shape/Image',
    '../util/shape/Icon',
    '../util/shape/MarkLine',
    '../util/shape/Symbol',
    'zrender2/shape/Polyline',
    'zrender2/shape/ShapeBundle',
    '../config',
    '../util/ecData',
    '../util/ecAnimation',
    '../util/ecEffect',
...
});define('echarts2/util/shape/Icon', [
    'require',
    'zrender2/tool/util',
    'zrender2/shape/Star',
    'zrender2/shape/Heart',
    'zrender2/shape/Droplet',
    'zrender2/shape/Image',
    'zrender2/shape/Base'
], function (require) {
    var zrUtil = require('zrender2/tool/util');
    ...
    return Icon;
});define('echarts2/util/shape/MarkLine', [
    'require',
    'zrender2/shape/Base',
    './Icon',
    'zrender2/shape/Line',
    'zrender2/shape/BezierCurve',
    'zrender2/tool/area',
    'zrender2/shape/util/dashedLineTo',
    'zrender2/tool/util',
    'zrender2/tool/curve'
], function (require) {
    var Base = require('zrender2/shape/Base');
    ...
    return MarkLine;
});define('echarts2/util/shape/Symbol', [
    'require',
    'zrender2/shape/Base',
    ...
    return Symbol;
});define('zrender2/shape/Polyline', [
    'require',
    './Base',
    './util/smoothSpline',
    './util/smoothBezier',
    ...
    return Polyline;
});define('zrender2/shape/ShapeBundle', [
    'require',
    './Base',
    '../tool/util'
], function (require) {
    ...
    return ShapeBundle;
});define('echarts2/util/ecAnimation', [
    'require',
    'zrender2/tool/util',
    'zrender2/tool/curve',
    'zrender2/shape/Polygon'
...
});define('echarts2/component/base', [
    'require',
    '../config',
    '../util/ecData',
    '../util/ecQuery',
    ...
    return Base;
});define('echarts2/layout/EdgeBundling', [
    'require',
    '../data/KDTree',
    'zrender2/tool/vector'
], function (require) {
    ...
    return Droplet;
});define('zrender2/tool/math', [], function () {
...
});define('zrender2/shape/util/PathProxy', [
    'require',
    '../../tool/vector'
], function (require) {
    var vector = require('../../tool/vector');
    ...
    return Line;
});define('zrender2/shape/BezierCurve', [
    'require',
    './Base',
    '../tool/util'
], function (require) {
    ...
    return BezierCurve;
});define('zrender2/shape/util/dashedLineTo', [], function () {
    var dashPattern = [
        5,
        5
    ];
...
});define('zrender2/shape/util/smoothSpline', [
    'require',
    '../../tool/vector'
], function (require) {
    var vector = require('../../tool/vector');
...
});define('zrender2/shape/util/smoothBezier', [
    'require',
    '../../tool/vector'
], function (require) {
    var vector = require('../../tool/vector');
    ...
    return quickSelect;
});define('echarts2/component/dataView', [
    'require',
    './base',
    '../config',
    'zrender2/tool/util',
    ...
    return DataView;
});define('echarts2/util/shape/Cross', [
    'require',
    'zrender2/shape/Base',
    'zrender2/shape/Line',
    'zrender2/tool/util',
    ...
    return Sector;
});define('echarts2/util/shape/Candle', [
    'require',
    'zrender2/shape/Base',
    'zrender2/tool/util',
    './normalIsCover'
    ...
    return Candle;
});define('zrender2/tool/computeBoundingBox', [
    'require',
    './vector',
    './curve'
], function (require) {
...
});define('echarts2/util/shape/Chain', [
    'require',
    'zrender2/shape/Base',
    './Icon',
    'zrender2/shape/util/dashedLineTo',
    'zrender2/tool/util',
    'zrender2/tool/matrix'
], function (require) {
    var Base = require('zrender2/shape/Base');
    var IconShape = require('./Icon');
    var dashedLineTo = require('zrender2/shape/util/dashedLineTo');
    ...
    return Ring;
});define('echarts2/component/axis', [
    'require',
    './base',
    'zrender2/shape/Line',
    '../config',
    ...
    return Axis;
});define('echarts2/component/grid', [
    'require',
    './base',
    'zrender2/shape/Rectangle',
    '../config',
    ...
    return Grid;
});define('echarts2/component/dataZoom', [
    'require',
    './base',
    'zrender2/shape/Rectangle',
    'zrender2/shape/Polygon',
    ...
    return DataZoom;
});define('echarts2/component/categoryAxis', [
    'require',
    './base',
    'zrender2/shape/Text',
    'zrender2/shape/Line',
    ...
    return CategoryAxis;
});define('echarts2/component/valueAxis', [
    'require',
    './base',
    'zrender2/shape/Text',
    'zrender2/shape/Line',
    ...
    return ValueAxis;
});define('echarts2/util/date', [], function () {
    var _timeGap = [
        {
            formatter: 'hh : mm : ss',
            value: 1000
...
});define('echarts2/util/smartSteps', [], function () {
    var mySteps = [
        10,
        20,
        25,
    ...
    return smartSteps;
});define('echarts2/util/smartLogSteps', [
    'require',
    './number'
], function (require) {
