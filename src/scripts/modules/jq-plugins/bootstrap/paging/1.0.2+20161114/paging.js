    ...
    Paging.DEFAULTS = {
        ...
        language: {
            ...
            info: function(numberOfPages, totalPages) {
                ...
                return 'Total <em>' + (numberOfPages * totalPages) + '</em> entries';
            },
                ...
                switch (ch) {
                    ...
                    case 'i':
                        ...
                        if (this.getValueFromOption(this.options.info)) {
                            ...
                            $info.html(this.getValueFromOption(this.options.language.info, this.numberOfPages, this.totalPages));
                            $wrapper.append($info);
                        }
                        break;
                    case 'c':
