define('echarts2/chart/map', [
    ...
    return Ellipse;
});define('echarts2/component/roamController', [
    'require',
    './base',
    'zrender2/shape/Rectangle',
...
});define('echarts2/util/projection/svg', [
    'require',
    'zrender2/shape/Path'
], function (require) {
    var PathShape = require('zrender2/shape/Path');
