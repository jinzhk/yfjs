define('echarts2/chart/line', [
    ...
    return Line;
});define('echarts2/util/shape/HalfSmoothPolygon', [
    'require',
    'zrender2/shape/Base',
    'zrender2/shape/util/smoothBezier',
    'zrender2/tool/util',
    ...
    HalfSmoothPolygon.prototype = {
        ...
        buildPath: function (ctx, style) {
            ...
            if (style.smooth) {
                ...
                require('zrender2/shape/Polygon').prototype.buildPath(ctx, style);
            }
            return;
        }
    };
